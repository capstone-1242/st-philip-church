    ...
    <?php endif; ?>
	 ...
	 <!-- Become a Member -->
		<section>
			...
			<ul>
				<li><a href="<?php echo esc_url( get_permalink(86) ) ?>">Non-Voting member</a></li>
				<li><a href="<?php echo esc_url( get_permalink(86) ) ?>">Voting member</a></li>
				<li><a href="<?php echo esc_url( get_permalink(86) ) ?>">Voting member-family</a></li>
			</ul>
