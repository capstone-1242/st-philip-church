...
<main id="primary" class="site-main">
	...
	?>
			...
			<p><?php echo wp_kses_post(get_field('responsibilities')); ?></p>

			<?php
			$committee_members = get_field('committee_members');
			$committee_chair = get_field('committee_chair');
			if (is_object($committee_chair)):
				$committee_chair_id = $committee_chair->ID; 
			elseif (is_array($committee_chair)):
				$committee_chair_id = $committee_chair[0]->ID;
			endif;
				...
				<div class="committee-list">
					...
					?>
						<div class="committee-member">
							...
							<!-- Chair Label -->
							<?php if ($committee_chair && $committee_chair->ID == $member->ID): ?>
