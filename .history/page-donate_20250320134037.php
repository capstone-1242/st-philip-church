	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-content">
			...
			<section>
				...
				<?php echo wp_kses_post(get_field('parish_message')); ?>
				<address>
				<?php echo wp_kses_post(get_field('parish_name')); ?>
				</address>
			</section>
			...
			<h2>Our Socials</h2>
			<ul>
				<li><a href="https://www.facebook.com/stphilipedmonton/">St.Philip Facebook <i class="fa-solid fa-arrow-up-right-from-square"></i></a></li>
				<li><a href="#">St.Philip Youtube <i class="fa-solid fa-arrow-up-right-from-square"></i></a></li>
			</ul>
