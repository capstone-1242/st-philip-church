	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-content">
			...
			<div class="panel">
				...
				<ol>
					<li><a href="#">Exploring the Ecumenical Councils</a></li>
					<li><a href="#">The Great Schism of 1054</a></li>
					<li><a href="#">The spread of Orthodoxy across the Byzantine Empire and beyond</a></li>
				</ol>
			</div>
