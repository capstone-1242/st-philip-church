...
<footer id="colophon" class="site-footer">
	<div> <!-- for wrapping the content and centering it -->
		<section class="site-branding">
			...
			<h2><a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
				<span class="footer-title-part1">St. Philip Antiochian</span>
				<span class="footer-title-part2">Orthodox Church</span></a></h2>
