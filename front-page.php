...
<div>
		...
		<div>
			...
			<section class="welcome">
				...
				<section>
					...
					<div>
						<div><span>9:20 AM</span><small>Orthros (Matins)</small></div>
						<div><span>10:20 AM</span><small>Divine Liturgy</small></div>
					</div>
				</section>
				<section>
					<h3>Join Online</h3>
					...
					<a href="<?php echo esc_url(get_permalink(72)); ?>" class="fake-button full-width-button">View Our Livestreams</a>
				</section>
			</section>
			...
			<section class="upcoming-events">
				...
				<a href="<?php echo esc_url(get_permalink(253)); ?>" class="fake-button full-width-button">View All Events (<?php echo $total_events ?>)</a>
			</section>
		</div>
</div>
	...
	<section>
		...
		<a href="<?php echo $archive_organization_url ?>" class="fake-button full-width-button">View the full list</a>
	</section>
	...
	<section class="donation">
		<div>
			...
			<a href="<?php echo esc_url(get_permalink(83)); ?>" class="fake-button full-width-button">Make a Donation</a>
		</div>
		<?php
		$donation_page_id = 83;
	...
	<section class="membership">
		...
		<a href="<?php echo esc_url(get_permalink(86)) ?>" class="fake-button full-width-button">View Full Details</a>
	</section>
